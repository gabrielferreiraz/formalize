...
function DetailModal({
  ...
  // Mensagem 1 — boas-vindas com e-mail e instrução de instalar (SEM senha)
  ...
  // Mensagem 2 — só a senha, fácil de copiar
      ...
      <div className="bg-stage-800 border border-stage-600 rounded-2xl p-6 w-full max-w-lg space-y-4 animate-scale-in max-h-[90dvh] overflow-y-auto">
        ...
        {credentials && (
          <div className="space-y-3 pt-2 border-t border-stage-600">
            ...
            {/* E-mail + senha para visualização/cópia */}
            ...
            <div className="space-y-2">
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl bg-green-700 hover:bg-green-600 text-white text-sm font-bold transition-colors"
              >
                ...
                1ª msg — Boas-vindas + link de acesso
              </a>
              <a
