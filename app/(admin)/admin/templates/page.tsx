...
import { TemplatePreviewModal, type PreviewTarget } from "@/components/templates/TemplatePreviewModal";
...
export default function TemplatesPage() {
  ...
  const [previewModal, setPreviewModal] = useState<PreviewTarget | null>(null);
  ...
  const handlePreview = (templateId: string) => {
    ...
    const tpl = items.find((t) => t.id === templateId);
    setPreviewModal({ id: templateId, type: tab, name: tpl?.name ?? templateId });
  };
  ...
  return (
    <div style={{ paddingBottom: 120 }}>
      ...
      <TemplatePreviewModal open={previewModal} onClose={() => setPreviewModal(null)} />
